...
describe('total likes', () => {
  ...
  test('when list has only one blog equals the likes of that', () => {
    const list = [{ nonsense: 28, likes: 9 }]
    const result = listHelper.totalLikes(list)
...
describe('favorite blog', () => {
  ...
  test('empty list returns undefiend', () => {
    const list = []
    const result = listHelper.favoriteBlog(list)
    expect(result).toEqual(undefined)
  })

  test('when list has only one blog equals the title, author and likes', () => {
    const list = [{ title: 'One and only', author: 'someone', likes: 9 }]
    const result = listHelper.favoriteBlog(list)
...
describe('most likes', () => {
  ...
  test('when list has only one blog give correct obj', () => {
    const list = [{ title: 'One and only', author: 'someone', likes: 9 }]
    const result = listHelper.mostLikes(list)
    expect(result).toEqual({
      author: 'someone',
